...
cs_db.query("INSERT INTO favourites (id_client, id_recepie) values (1, 2)")
...
print(cs_db.query("""SELECT * FROM clients WHERE name = 'Ivan'"""))
print(cs_db.query('SELECT * FROM favourites'))
print(cs_db.query('SELECT * FROM recepies WHERE id in (1,2)'))
#for i in cs_db.get_favourites("Ivan"): print(i+'\n')
#for i in cs_db.get_recepie_by_name('name test 3'): print(i+'\n')
